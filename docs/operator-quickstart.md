# Operator Quickstart — Activities of professional membership organizations

Shortest path from clone to a verified local dry-run for **ISIC 9412** (`cloud-itonami-isic-9412`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9412.git
cd cloud-itonami-isic-9412
```
...
- Likely source path: `association.governor.cljc`
